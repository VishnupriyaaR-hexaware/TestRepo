...
using ElmahCore.Mvc;
using ElmahCore;
using klbhvg.Api.Filters;
using klbhvg.Business.Installer;

namespace klbhvg.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "klbhvg API", Version = version + "-" + branch});
            });
