using createcomp.Api.Installer;
using createcomp.Api.Middleware;
using ElmahCore.Mvc;
...
using createcomp.Api.Opentelemetry;
using OpenTelemetry;
    ...
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "createcomp V1");
        });
