...
using createcomp.Api.Filters;
using createcomp.BusinessServices.Installer;

namespace createcomp.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "createcomp API", Version = version + "-" + branch});
            });
