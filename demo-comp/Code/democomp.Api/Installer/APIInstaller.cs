...
using ElmahCore.Mvc;
using ElmahCore;
using democomp.Api.Filters;
using democomp.Business.Installer;

namespace democomp.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "democomp API", Version = version + "-" + branch});
            });
