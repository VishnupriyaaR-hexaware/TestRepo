...
using final.Api.Filters;
using final.BusinessServices.Installer;

namespace final.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "final API", Version = version + "-" + branch});
            });
