...
using bugg.Api.Filters;
using bugg.BusinessServices.Installer;

namespace bugg.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "bugg API", Version = version + "-" + branch});
            });
