...
using ElmahCore.Mvc;
using ElmahCore;
using testdotnet.Api.Filters;
using testdotnet.Business.Installer;

namespace testdotnet.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "testdotnet API", Version = version + "-" + branch});
            });
