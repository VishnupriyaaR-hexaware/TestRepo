...
using jkhugyjfhgdf.Api.Filters;
using jkhugyjfhgdf.BusinessServices.Installer;

namespace jkhugyjfhgdf.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "jkhugyjfhgdf API", Version = version + "-" + branch});
            });
