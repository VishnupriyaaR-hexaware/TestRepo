...
using ElmahCore.Mvc;
using ElmahCore;
using PullReqTest.Api.Filters;
using PullReqTest.Business.Installer;

namespace PullReqTest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PullReqTest API", Version = version + "-" + branch});
            });
