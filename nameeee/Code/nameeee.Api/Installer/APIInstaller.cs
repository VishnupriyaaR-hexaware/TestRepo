...
using nameeee.Api.Filters;
using nameeee.BusinessServices.Installer;

namespace nameeee.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "nameeee API", Version = version + "-" + branch});
            });
