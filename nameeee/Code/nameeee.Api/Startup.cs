using nameeee.Api.Installer;
using nameeee.Api.Middleware;
using ElmahCore.Mvc;
...
using nameeee.Api.Opentelemetry;
using OpenTelemetry;
    ...
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "nameeee V1");
        });
