...
using kayy.Api.Filters;
using kayy.BusinessServices.Installer;

namespace kayy.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "kayy API", Version = version + "-" + branch});
            });
