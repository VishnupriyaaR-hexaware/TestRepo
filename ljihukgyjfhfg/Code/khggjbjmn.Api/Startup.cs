using khggjbjmn.Api.Installer;
using khggjbjmn.Api.Middleware;
using ElmahCore.Mvc;
...
using khggjbjmn.Api.Opentelemetry;
using OpenTelemetry;
    ...
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "khggjbjmn V1");
        });
