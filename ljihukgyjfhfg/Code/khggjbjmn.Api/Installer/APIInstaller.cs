...
using khggjbjmn.Api.Filters;
using khggjbjmn.BusinessServices.Installer;

namespace khggjbjmn.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "khggjbjmn API", Version = version + "-" + branch});
            });
