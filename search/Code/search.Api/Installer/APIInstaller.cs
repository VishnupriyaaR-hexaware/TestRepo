...
using search.Api.Filters;
using search.BusinessServices.Installer;

namespace search.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "search API", Version = version + "-" + branch});
            });
