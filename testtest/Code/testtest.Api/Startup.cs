using testtest.Api.Installer;
using testtest.Api.Middleware;
using ElmahCore.Mvc;
...
using testtest.Api.Opentelemetry;
using OpenTelemetry;
    ...
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "testtest V1");
        });
