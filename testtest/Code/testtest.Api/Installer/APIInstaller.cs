...
using testtest.Api.Filters;
using testtest.BusinessServices.Installer;

namespace testtest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "testtest API", Version = version + "-" + branch});
            });
